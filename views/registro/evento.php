<div class="evento">
    ...
    <div class="evento__informacion">
        ...
        <div class="evento__autor-info">
            <picture>
                <source 
                    srcset="<?php echo $_ENV["HOST"];?>/img/speakers/<?php echo $evento->ponente->imagen ?>.webp"
                    type="image/webp"
                >
                <source 
                    srcset="<?php echo $_ENV["HOST"] ;?>/img/speakers/<?php echo $evento->ponente->imagen ?>.png"
                    type="image/png"
                >
                <img 
                    src="<?php echo $_ENV["HOST"];?>/img/speakers/<?php echo $evento->ponente->imagen ?>.png" 
