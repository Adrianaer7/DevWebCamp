<main class="pagina">
    ...
    <p class="pagina__descripcion">Te recomiendo almacenarlo, puedes compartirlo en tus redes sociales.</p>

    <div class="boleto-virtual">
        <div class="boleto boleto--acceso boleto--<?php echo strtolower($registro->paquete->nombre)?>">
