        ...
        <?php foreach($ponentes as $ponente) {; ?>
            <div class="speaker">
                <picture>
                    ...
                    >
                    <source 
                        srcset="img/speakers/<?php echo $ponente->imagen ?>.png"
                        type="image/png"
                    >
                    <img 
                ...
                <div class="speaker__informacion">
                    ...
                    <nav class="speaker-sociales">
                        <?php $redes = json_decode($ponente->redes); ?> <!--convierto el string de redes con formato json, a un objeto de php-->
                    ...
                    <ul class="speaker__listado-skills">
                        <?php 
                            ...
                            foreach($tags as $tag) {
                        ?>
                        <li class="speaker__skills"><?php echo $tag; ?></li>
                        <?php }; ?>
                    </ul>
                </div>
            </div>
