<footer class="footer">
    <div class="footer__grid">
        <div class="footer__contenido">
                <h3 class="footer__logo">&#60;DevWebCamp/></h2>
                <p class="footer__texto">
                    DevWebCamp es una confrenecia para desarrolladores de todos los niveles, se lleva a cabo de froma presencial y en linea.
                </p>
        </div>
        <nav class="menu-redes"> 
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https:/www./twitter.com">
                <span class="menu-redes__ocultar">Twitter</span>
            </a> 
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://www.tiktok.com">
            ...
            <a class="menu-redes__enlace" rel="noopener noreferrer" target="_blank" href="https://www.github.com">
